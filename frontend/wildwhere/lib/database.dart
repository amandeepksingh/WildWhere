...
class Database {
  Future<http.Response> createPost(
    ...
    var url = Uri.parse(
        'http://ec2-13-58-233-86.us-east-2.compute.amazonaws.com:80/posts/createPost');
  ...
  Future<http.Response> getPostByPID(String pid) async {
    var url = Uri.parse(
        'http://ec2-13-58-233-86.us-east-2.compute.amazonaws.com:80/posts/selectPost?pid=$pid');
  ...
  Future<http.Response> updatePostByPID(
    ...
    var url = Uri.parse(
        'http://ec2-3-138-136-228.us-east-2.compute.amazonaws.com/posts/updatePostByPID');
  ...
  Future<http.Response> deletePostByPID({required String pid}) async {
    var url = Uri.parse(
        'http://ec2-3-138-136-228.us-east-2.compute.amazonaws.com/posts/deletePostByPID?pid=$pid');
