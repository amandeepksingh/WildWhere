...
class AppleSignInButtonState extends State<AppleSignInButton> {
  ...
  Widget build(BuildContext context) {
    return ElevatedButton.icon(
      ...
      icon: Image.asset(
        'assets/images/apple.png', // assuming you have an Apple icon
        width: 30,
        height: 30,
      ),
  ...
  // handles Apple sign in and creating a new user object/prefs if needed
  void handleSignIn() async {
    try {
      await UserController.loginWithApple();
    } catch (e) {
