...
describe("HELP: provide documentation on valid endpoint, invalid method", () => {
    it("HELP: test help method", async () => {
        ...
        assert.strictEqual(helpTxt,"This endpoint or method is not supported at this time. Please refer to the following supported endpoints and methods: [GET users/selectUser, POST users/createUser, PUT users/updateUserByUID, DELETE users/deleteUserByUID, GET posts/selectPost, POST posts/createPost, PUT posts/updatePostByPID, DELETE posts/deletePostByPID]")
    })
