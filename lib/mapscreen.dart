...
Future<void> _fetchDataFromDatabase() async {
    try {
      var response = await db.getPostByPID("1");
      ...
      child: Column(
        children: <Widget>[
          FloatingActionButton(
            onPressed: () => moveToCurrentLocation(mapController),
            shape: const CircleBorder(),
            elevation: 2,
            backgroundColor: const Color.fromARGB(255, 255, 255, 255),
...
void moveToCurrentLocation(var controller) async {
  Location location = Location();
  await location.checkLocationPerms();
